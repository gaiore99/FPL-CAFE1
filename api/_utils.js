// CommonJS helpers
async function robustJsonFetch(url, opts = {}) {
  const { headers = {}, retry = 2 } = opts;
  const common = {
    headers: {
...
function okJson(res, data, cache = "s-maxage=30, stale-while-revalidate=60") {
...
module.exports = { robustJsonFetch, okJson, errJson };
